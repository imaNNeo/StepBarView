...
|sbv_draw_step_index|Integer|`drawStepIndex`|you can set this property false to prevent showing indexes (then just a solid circle will be drawn), default value is `true`|
