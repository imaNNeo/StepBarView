...
you can download the [Demo apk file](https://github.com/imaNNeoFighT/StepBarView/raw/master/repo_files/SbvDemo1-0-4.apk) (you can first adjust your StepBar in the demoApp and then implement it in code)
